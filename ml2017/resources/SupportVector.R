...
# Fit an optimally tuned Support Vector Classifier on the train set
# by performing cross-validation with a range of values of the cost
tuneModel <- tune(svm, 
                  Species ~ ., 
                  data = irisTrain, 
                  kernel = "linear",
