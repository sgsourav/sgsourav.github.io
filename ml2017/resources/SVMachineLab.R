...
# =======================================================
# SVM Lab : Part 1 : Multi-Class Classification (tuned)
# =======================================================
...
# =======================================================
# SVM Lab : Part 2 : Mixture Model of Gaussians (tuned)
# =======================================================

# Create an artificial dataset
x <- matrix(rnorm(200*2), ncol=2)             # 200 two-dimensional data points
x[1:100,] <- x[1:100,] + 3                    # rearrange the 2-dim data points
x[101:150,] <- x[101:150,] - 3                # to make the problem interesting
...
# =======================================================
# SVM Lab : Part 3 : Multi-Feature Multi-Class (tuned)
# =======================================================
